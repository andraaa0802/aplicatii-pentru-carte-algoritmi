...
namespace P2
{
    class Program
    {
        ...
        /// fiecare număr având cel mult 4 cifre. Scrieţi un program C# care citeşte numerele din fişierul NR.TXT şi afişează pe ecran, 
        /// separate prin câte un spaţiu, în ordine descrescătoare, toate numerele din fişier care au cel mult 2 cifre. Dacă fişierul nu conţine
        /// astfel de numere se va afişa pe ecran mesajul NU EXISTA.
        /// </summary>
        static void Main(string[] args)
        {
            StreamReader sr = new StreamReader(@"C:\Users\CRISTI\Desktop\AplicatiiCarte\MetodeSortare\P2\NR.txt");
